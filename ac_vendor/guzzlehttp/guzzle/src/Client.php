...
use AcVendor\GuzzleHttp\Promise;
...
class Client implements ClientInterface
{
     ...
     *
     * @see \AcVendor\GuzzleHttp\RequestOptions for a list of available request options.
     */
     ...
     *                       request and to the transfer. See \AcVendor\GuzzleHttp\RequestOptions.
     *
     ...
     * @param array               $options Request options to apply. See \AcVendor\GuzzleHttp\RequestOptions.
     *
     * @return PromiseInterface
     */
     ...
     *
     * @param array $options See \AcVendor\GuzzleHttp\RequestOptions.
     *
     * @return Promise\PromiseInterface
     */
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        if (isset($options['json'])) {
            $options['body'] = \AcVendor\GuzzleHttp\json_encode($options['json']);
            unset($options['json']);
            // Ensure that we don't have the header in different case and set the new value.
            $options['_conditional'] = Psr7\_caseless_remove(['Content-Type'], $options['_conditional']);
